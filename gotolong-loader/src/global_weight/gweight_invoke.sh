...
IN_FILE_NSE=$CONFIG_GLOBAL_DATA_LOC/gweight-data/gweight-data.csv
OUT_FILE_1=$CONFIG_GLOBAL_REPORTS_LOC/gweight-reports/gweight-reports.csv
...
python gweight_invoke.py -d ${DEBUG_LEVEL} -i ${IN_FILE_NSE} -o ${OUT_FILE_1}  ${OUT_FILE_2}
