...
class Config(object):
    ...
    def get_root(self):
        ...
        config_root = os.environ.get('GOTOLONG_HOME')
        # remove /src
        # print(config_root)
        return config_root
    ...
    def get_data(self):
        return os.path.join(self.get_root(), 'data')

    def get_global_data(self):
        return os.path.join(self.get_data(), 'input-global-data')

    def get_global_reports(self):
        return os.path.join(self.get_data(), 'output-global-reports')

    def get_profile_data(self):
        return os.path.join(self.get_data(), 'input-user-data')

    def get_profile_reports(self):
        return os.path.join(self.get_data(), 'output-user-reports')
    ...
    def get_config_file(self):
        return os.path.join(self.get_root(), 'config/config.ini')
