...
IN_FILE_1=$CONFIG_GLOBAL_DATA_LOC/fratio-data/fratio-data.csv
OUT_FILE_1=$CONFIG_GLOBAL_REPORTS_LOC/fratio-reports/fratio-reports.csv
...
mkdir -p `dirname ${IN_FILE_1}`
mkdir -p `dirname ${OUT_FILE_1}`
python fratio.py -d ${DEBUG_LEVEL} -i ${IN_FILE_1} -o ${OUT_FILE_1}
