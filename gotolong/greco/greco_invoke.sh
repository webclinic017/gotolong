...
# IN_FILE_NSE=$CONFIG_GLOBAL_DATA_LOC/greco-data/greco-data.csv
OUT_FILE_1=$CONFIG_GLOBAL_REPORTS_LOC/greco-reports/greco-reports.csv
...
python greco.py -d ${DEBUG_LEVEL} -o ${OUT_FILE_1}
