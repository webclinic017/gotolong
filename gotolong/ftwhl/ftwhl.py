...
class Ftwhl(Amfi):
    ...
    def ftwhl_insert_data(self, in_filename):
        ...
        create_sql = gotolong.cutil.cutil.get_create_sql(self.ftwhl_table_name, self.ftwhl_table_dict)
        insert_sql = gotolong.cutil.cutil.get_insert_sql(self.ftwhl_table_name, self.ftwhl_table_dict)
