...
do
    ...
    IN_FILE_2=$CONFIG_GLOBAL_REPORTS_LOC/screener-reports/screener-reports-fltr-buy-ticker-only.csv

    IN_FILE_3=$CONFIG_GLOBAL_REPORTS_LOC/screener-reports/screener-reports-fltr-hold-ticker-cause.csv

    IN_FILE_4=$CONFIG_GLOBAL_REPORTS_LOC/screener-reports/screener-reports-fltr-sale-ticker-cause.csv
