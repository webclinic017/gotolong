...
class DematSumRankView(ListView):
    ...
    queryset = DematSum.objects.all().annotate(comp_rank=Subquery(amfi_qs.values('comp_rank')[:1])). \
        values('stock_symbol', 'company_name', 'value_cost', 'comp_rank').order_by('comp_rank')
