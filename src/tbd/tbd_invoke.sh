...
OUT_FILE_1=$PROJ_REPORTS_LOC/tbd-reports/tbd-reports-phase-buy-1.csv
OUT_FILE_2=$PROJ_REPORTS_LOC/tbd-reports/tbd-reports-phase-buy-2.csv
OUT_FILE_3=$PROJ_REPORTS_LOC/tbd-reports/tbd-reports-phase-buy-3.csv
OUT_FILE_4=$PROJ_REPORTS_LOC/tbd-reports/tbd-reports-phase-buy-4.csv
OUT_FILE_5=$PROJ_REPORTS_LOC/tbd-reports/tbd-reports-phase-sale-1.csv
# 6 months
DAYS_DIFF=180
