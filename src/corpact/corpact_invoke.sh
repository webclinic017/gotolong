...
IN_FILE_1=$CONFIG_REPORTS_LOC/bse-reports/all/bse-all-corpact.csv
OUT_FILE_1=$CONFIG_REPORTS_LOC/corpact-reports/corpact-reports-phase-1.csv
OUT_FILE_2=$CONFIG_REPORTS_LOC/corpact-reports/corpact-reports-phase-1.txt
