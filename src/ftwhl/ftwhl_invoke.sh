...
IN_FILE_1=$CONFIG_DATA_LOC/ftwhl-data/ftwhl.csv
OUT_FILE_1=$CONFIG_REPORTS_LOC/ftwhl-reports/ftwhl-reports.csv
OUT_FILE_2=$CONFIG_REPORTS_LOC/ftwhl-reports/ftwhl-reports.txt
