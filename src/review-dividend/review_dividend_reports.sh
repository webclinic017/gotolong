...
mkdir -p ${PROJ_PROFILE_REPORTS_LOC}/review-dividend-reports
...
do
	...
	comm -13 ${DIV_NAME} ${PLAN_NAME} > ${PROJ_PROFILE_REPORTS_LOC}/review-dividend-reports/plan_plus_divid_none-${DIV_YEAR}.txt
done

# should be done later
# comm -23 ${DIV_NAME} ${PLAN_NAME} > ${PROJ_PROFILE_REPORTS_LOC}/review-dividend-reports/review_plan_none_dividend_plus.txt
