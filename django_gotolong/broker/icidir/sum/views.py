...
class BrokerIcidirSumTickerView(ListView):
    model = BrokerIcidirSum
    ...
    queryset = BrokerIcidirSum.objects.values('stock_symbol')
...
class BrokerIcidirSumRankView(ListView):
    # model = BrokerIcidirSum
    ...
    # queryset = BrokerIcidirSum.objects.annotate(comp_rank=Subquery(amfi_qset.values('comp_rank'))).order_by('comp_rank')
    # queryset = BrokerIcidirSum.objects.annotate(comp_rank=Subquery(amfi_qset.values('comp_rank')))
...
class BrokerIcidirSumRecoView(ListView):
    # model = BrokerIcidirSum
...
class BrokerIcidirSumAmountView(ListView):
    # model = BrokerIcidirSum
...
class BrokerIcidirSumCapTypeView(ListView):
    # model = BrokerIcidirSum
...
def BrokerIcidirSumUpload(request):
    ...
    debug_level = 1
    # declaring template
    template = "broker/icidir/sum/dematsum_list.html"
