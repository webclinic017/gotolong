...
class Mfund(models.Model):
    ...
    mf_units = models.FloatField(blank=True, null=True)
    mf_acp = models.FloatField(blank=True, null=True)
    mf_cost_value = models.FloatField(blank=True, null=True)
    mf_nav_date = models.TextField(blank=True, null=True)
    mf_nav = models.FloatField(blank=True, null=True)
    mf_nav_value = models.FloatField(blank=True, null=True)
    mf_pnl_realized = models.FloatField(blank=True, null=True)
    mf_pnl = models.FloatField(blank=True, null=True)
    mf_pnl_pct = models.FloatField(blank=True, null=True)
