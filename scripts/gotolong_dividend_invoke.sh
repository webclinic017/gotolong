...
do
    ...
    python -m gotolong.dividend.dividend -t -l ${LOGGING_LEVEL} -i ${IN_FILE_BANK_STMT} -a ${IN_FILE_ALIASES} -o ${OUT_FILE_0} ${OUT_FILE_1} ${OUT_FILE_2} ${OUT_FILE_3} ${OUT_FILE_4} ${OUT_FILE_5} ${OUT_FILE_6} ${OUT_FILE_7}
